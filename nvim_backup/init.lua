...
-- use < and > with CTRL to move between tabs
vim.keymap.set('n', '<C-.>', ':tabnext<CR>', { noremap = true, silent = true, desc = 'Next Tab' })
vim.keymap.set('n', '<C-,>', ':tabprevious<CR>', { noremap = true, silent = true, desc = 'Previous Tab' })
...
require('lazy').setup({
  -- NOTE: Import plugins from other places
